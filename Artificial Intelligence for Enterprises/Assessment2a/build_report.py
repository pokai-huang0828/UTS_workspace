...
("表五為情境試算(假設毛利率 60%、每名挽回客戶保留十二個月毛利 A$422):三項行動的損益兩平增量留存率"
...
table(doc, '表五、三項行動之量化商業案例(損益兩平與淨效益試算)',
    ...
    [['一、服務恢復', 'A$15', '—', 'A$10,440', '182 人', '13.6%', '+A$4,892'],
     ['二、續約轉化', 'A$5', 'A$59(一個月折抵)', 'A$1,615', '137 人', '3.2%', '+A$8,328'],
     ['三、資費重組', 'A$10', 'A$70(月費調降 10%×12)', 'A$7,670', '240 人', '9.1%', '+A$9,231']],
    '註:成本為估計值,誘因僅於挽留成功時發生;人數與流失率為 notebook 實算。', font_size=8.5)
