...
- [ ] 🟡 **`Machine Learning/README.md` 課程總整理的 Codex 第 2、3 輪審查** —— 2026-09-15 第 1 輪已跑完並修正,第 2、3 輪撞 Codex 用量上限中斷(**額度 2026-09-16 02:41 恢復**)。
      第 2 輪查:第 1 輪缺陷是否都關閉 + 新加內容(§6.5 第 5–8 列、§6.4 執行平台、91 的 9/10「老師重申」);第 3 輪:全件終審,拿到 READY 後拿掉 README 頂端的查證狀態提示
