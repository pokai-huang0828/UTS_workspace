...
> | 十頁內容 / 圖 / 投影片 / 講稿 / 錄影 | ⬜ **全部未完成** |
>
> ### 主線一句話
> **ADAS 錯的是模型,DMS 錯的是人。同一套複核流程在處理兩個本質不同的問題,所以兩邊都沒被解決。**
> 而人工判讀產能已經是「還能接多少客戶」的天花板。
>
> ### 🔴 待辦(依優先序)
> - [ ] **① 內容 workflow 跑到一半** — run `wf_92328b60-bee`,
>       script `…/workflows/scripts/a3-v4-content-draft-wf_cd7cebca-d44.js`。
>       未完成就用 `Workflow({scriptPath, resumeFromRunId:'wf_92328b60-bee'})` 續跑(已完成的走快取)
> - [ ] ② 出圖(★ 兩個 30 分項各至少一個專業視覺化)
> - [ ] ③ 組版 → 逐頁渲染稽核
> - [ ] ④ 講稿定稿 + 配時**程式驗算**(目標 520–530 秒,硬上限 600)
