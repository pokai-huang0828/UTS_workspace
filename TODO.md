...
- [ ] 🔴 **2026-08-05(週三)是管濟偉場次 = 評分老師本人**,當面問三題:
      ①「A2a 五項有四項都 85%,要到『優異』還差什麼?」(最值錢 —— 兩次作業都卡在檔次邊界)
      ②「引用您期待的是方法學出處,還是也要有支撐商業建議的產業文獻?」(A2b 三筆全是方法學)
      ③「A3 沿用我 A1 的 CBA 案例可以嗎?」(李春平說有同學選的例子「比較舊」)
