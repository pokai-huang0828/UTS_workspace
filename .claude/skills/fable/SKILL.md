---
name: fable
description: Fable 治理框架(自 MiTAC-VMX 移植)— 主模型當指揮官,派工給 Claude subagents 生產、Codex(gpt-5.5 異家族)對抗驗證的多代理協作架構。多步驟任務、批次讀檔、事實類交付、需要第二意見時使用。
---
...
| Codex CLI | gpt-5.5(codex-cli 0.142.3) | **本機 2026-07-16 實測 PASS**:`--sandbox read-only` 直接可用,**不需要** VMX 公司機的 bypass 旗標。配方見 [references/codex-collab.md](references/codex-collab.md) |
